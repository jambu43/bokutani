      ...
      <section className="py-20 px-6 bg-gradient-to-br from-gray-50 to-white relative overflow-hidden">
        ...
        <div className="container mx-auto max-w-6xl relative z-10">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              {/* Carte Adresse */}
              <div className="bg-white p-4 md:p-8 rounded-2xl shadow-xl border border-gray-100 hover:shadow-2xl transition-all">
                <div className="flex flex-col sm:flex-row items-start gap-4 mb-6">
                  <div className="bg-gradient-to-br from-[#0ba0da] to-[#2d1654] text-white rounded-xl p-3 md:p-4 w-14 h-14 md:w-[60px] md:h-[60px] flex items-center justify-center flex-shrink-0">
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="text-xl md:text-2xl font-black text-black mb-3 md:mb-4">ADRESSE</h3>
                    <div className="space-y-2 md:space-y-3 text-gray-700">
                      <p className="text-base md:text-lg font-bold text-black">BOKUTANI</p>
                      <p className="text-sm md:text-lg leading-relaxed">
                        3ème niveau Galleria Mall<br/>
                        9, Avenue Colonel Lukusa 6133<br/>
                        Kinshasa-Gombe
                      </p>
                      <p className="text-xs md:text-base text-gray-500 italic">
              ...
              <div className="bg-white p-4 md:p-8 rounded-2xl shadow-xl border border-gray-100 hover:shadow-2xl transition-all">
                <div className="flex flex-col sm:flex-row items-start gap-4 mb-6">
                  <div className="bg-gradient-to-br from-[#fc9937] to-[#0ba0da] text-white rounded-xl p-3 md:p-4 w-14 h-14 md:w-[60px] md:h-[60px] flex items-center justify-center flex-shrink-0">
                    <svg className="w-5 h-5 md:w-6 md:h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                    </svg>
                  </div>
                  <div className="flex-1 min-w-0 w-full">
                    <h3 className="text-xl md:text-2xl font-black text-black mb-3 md:mb-4">CONTACT</h3>
                    <div className="space-y-3 md:space-y-4">
                      <a 
                        href="tel:+243XXXXXXXXX" 
                        className="flex items-center gap-3 md:gap-4 p-3 md:p-4 bg-gray-50 rounded-lg hover:bg-[#0ba0da]/10 transition-colors group"
                      >
                        <div className="bg-[#0ba0da] text-white rounded-lg p-2 md:p-3 flex-shrink-0 group-hover:scale-110 transition-transform">
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          <p className="text-sm md:text-lg font-semibold text-black truncate">[À compléter]</p>
                        </div>
                      </a>
                      <a 
                        ...
                        className="flex items-center gap-3 md:gap-4 p-3 md:p-4 bg-gray-50 rounded-lg hover:bg-[#0ba0da]/10 transition-colors group"
                      >
                        <div className="bg-[#fc9937] text-white rounded-lg p-2 md:p-3 flex-shrink-0 group-hover:scale-110 transition-transform">
                          <svg className="w-4 h-4 md:w-5 md:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                          </svg>
                        </div>
                        <div className="min-w-0 flex-1">
                          ...
                          <p className="text-sm md:text-lg font-semibold text-[#0ba0da] break-all">contact@bokutani.cd</p>
                        </div>
                      </a>
                    </div>
                  </div>
              ...
              {/* Carte Horaires */}
              <div className="bg-gradient-to-br from-[#0ba0da] to-[#2d1654] text-white p-4 md:p-8 rounded-2xl shadow-xl hover:shadow-2xl transition-all">
                <div className="flex flex-col sm:flex-row items-start gap-4 mb-6">
                  <div className="bg-white/20 backdrop-blur-sm rounded-xl p-3 md:p-4 w-14 h-14 md:w-[60px] md:h-[60px] flex items-center justify-center flex-shrink-0">
                    <svg className="w-5 h-5 md:w-6 md:h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                  </div>
                  <div className="flex-1 min-w-0 w-full">
                    <h3 className="text-xl md:text-2xl font-black mb-3 md:mb-4">HORAIRES</h3>
                    <div className="space-y-2 md:space-y-3">
                      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-0 p-3 bg-white/10 rounded-lg backdrop-blur-sm">
                        <span className="font-semibold text-sm md:text-base">Lundi - Vendredi</span>
                        <span className="font-bold text-sm md:text-base">9h - 22h</span>
                      </div>
                      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-0 p-3 bg-white/10 rounded-lg backdrop-blur-sm">
                        <span className="font-semibold text-sm md:text-base">Samedi - Dimanche</span>
                        <span className="font-bold text-sm md:text-base">10h - 00h</span>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="relative group">
              ...
              <div className="relative h-full min-h-[400px] md:min-h-[600px] rounded-2xl overflow-hidden shadow-2xl">
                <iframe
                  ...
                  className="rounded-2xl min-h-[400px] md:min-h-[600px]"
                ></iframe>
                <div className="absolute top-2 right-2 md:top-4 md:right-4 bg-white/90 backdrop-blur-sm px-3 py-1.5 md:px-4 md:py-2 rounded-lg shadow-lg">
                  <p className="text-xs md:text-sm font-bold text-black">📍 Galleria Mall</p>
                </div>
              </div>
            </div>
          </div>
