  ...
  return (
    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="absolute inset-0 opacity-10">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] rounded-full border-2 border-[#0ba0da]" />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full border border-[#0ba0da]" />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] rounded-full border border-[#0ba0da]" />
      </div>

      <div className="relative z-10">
        <div className="text-center mb-16">
          <p className="text-[#0ba0da] text-sm font-bold tracking-wide mb-2">BATTLE ARENA</p>
          <h3 className="text-white text-5xl font-black">MODES DE JEU</h3>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {/* Skirmish Mode */}
          <div className="bg-black rounded-2xl overflow-hidden relative h-full border border-gray-800 hover:border-[#0ba0da] transition-colors">
            ...
            <div className="p-6">
              ...
              <ul className="text-gray-400 text-sm leading-relaxed space-y-2 mt-3">
                <li className="flex items-start">
                  <span className="text-[#0ba0da] mr-2 mt-1">▸</span>
