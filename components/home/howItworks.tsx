            ...
            <div className="space-y-8">
              ...
              <div className="text-center">
                <h4 className="text-2xl md:text-4xl font-black mb-4">
                  <span className="text-[#5B3FFF]">COMMENT</span>
                  <br />
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white rounded-2xl p-8 border-2 border-gray-100">
                  <div className="text-[#5B3FFF] font-black text-sm mb-2">ÉTAPE 1</div>
                ...
                {/* Step 2 */}
                <div className="bg-white rounded-2xl p-8 border-2 border-gray-100">
                  <div className="text-[#5B3FFF] font-black text-sm mb-2">ÉTAPE 2</div>
                ...
                {/* Step 3 */}
                <div className="bg-white rounded-2xl p-8 border-2 border-gray-100">
                  <div className="text-[#5B3FFF] font-black text-sm mb-2">ÉTAPE 3</div>
                ...
                {/* Step 4 */}
                <div className="bg-white rounded-2xl p-8 border-2 border-gray-100">
                  <div className="text-[#5B3FFF] font-black text-sm mb-2">ÉTAPE 4</div>
