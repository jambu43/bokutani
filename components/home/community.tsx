    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="text-center mb-12">
        <h4 className="text-3xl md:text-4xl font-black mb-6">
          ...
          <span className="text-[#0ba0da]">Bokutani</span>
        </h4>
        ...
        {/* Discord Button */}
        <button className="px-8 py-4 bg-[#0ba0da] hover:bg-[#0ba0da] text-white font-bold rounded-full transition-colors flex items-center gap-3 mx-auto shadow-lg">
