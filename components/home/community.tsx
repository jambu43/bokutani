    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="text-center mb-12">
        <h4 className="text-3xl md:text-4xl font-black mb-6">
          <span className="text-black">LA COMMUNAUTÉ </span>
          <span className="text-[#fc9937]">Bokutani</span>
        </h4>
        <p className="text-gray-700 text-lg leading-relaxed max-w-3xl mx-auto mb-8">
          Rejoignez la communauté EVA sur Discord, retrouvez les joueurs de votre salle, accédez à des codes promos
          exclusifs et des actualités en avant-première.
        </p>

        {/* Discord Button */}
        <button className="px-8 py-4 bg-[#fc9937] hover:bg-[#fc9937] text-white font-bold rounded-full transition-colors flex items-center gap-3 mx-auto shadow-lg">
